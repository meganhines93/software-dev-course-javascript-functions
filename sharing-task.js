...
function generateBadge(name, role){
            let capitalizeRole = role.charAt(0).toUpperCase() + role.slice(1);

    return `Name: ${name}, Role: ${capitalizeRole}`

}
let result = generateBadge("Alice", "speaker");
...
{ let totalCost = attendees * costPerAttendee; 
    if (attendees > 100) { totalCost = totalCost * 0.9;} return totalCost}
console.log(calculateTotalCost(105, 50));
...
let userEmail = readline.question("Enter an email: ");

console.log("Is email valid? " + validateEmail(userEmail));
